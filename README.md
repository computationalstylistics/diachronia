...
Wersja elektroniczna znajduje się [tutaj](https://github.com/computationalstylistics/diachronia/blob/master/Zmiana_w_jezyku_2019-10-15.epub) (epub) oraz [tutaj](https://github.com/computationalstylistics/diachronia/blob/master/Zmiana_w_jezyku_2019-10-15.mobi) (kindle). Ilustracje do książki do znalezienia [tutaj](https://github.com/computationalstylistics/diachronia/tree/master/ilustracje), a dane użyte w obliczeniach umieściliśmy [tutaj](https://github.com/computationalstylistics/diachronia/tree/master/dane).
